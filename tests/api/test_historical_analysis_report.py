...
def test_function_succeeding(s3_bucket):
    ...
    json_load_1 = {
        "status": "Completed",
        "allDurationInSeconds": 249.003,
        "avgprovisionedMemoryMB": 152.587875,
        "MemoryCost": 0.000783477,
        "InvocationCost": 0.0000116,
        "totalCost": 0.000795077,
        "avgCostPerInvocation": 0.000146568,
        "avgmaxMemoryUsedMB": 92.5064,
        "avgoverProvisionedMB": 60.081475,
        "optimalTotalCost": 0.000382066,
        "potentialSavings": 0.0004128712,
        "avgDurationPerInvocation": 37.33415,
    }
    json_load_2 = {
        "status": "Completed",
        "allDurationInSeconds": 500.003,
        "avgprovisionedMemoryMB": 300.587875,
        "MemoryCost": 0.000783477,
        "InvocationCost": 0.0000116,
        "totalCost": 0.000795077,
        "avgCostPerInvocation": 0.000146568,
    ...
    upload_file_to_s3(
        json.dumps(json_load_1), "json_load_1.json", s3_bucket, prefix_name
    )
    upload_file_to_s3(
