...
def test_get_lambda_cost_full_logic(mock_lambda_client, mock_cloudwatch_client, mock_query_results, aws_credentials):
    ...
    # Mock start_query
    mock_cloudwatch_client.start_query.return_value = {
...
@patch('step_function.analysis_generator.cloudwatch_client')
@patch('step_function.analysis_generator.lambda_client')
def test_get_lambda_cost_no_log_group(mock_lambda_client, mock_cloudwatch_client, aws_credentials):
...
@patch('step_function.analysis_generator.cloudwatch_client')
@patch('step_function.analysis_generator.lambda_client')
def test_get_lambda_cost_no_invocations(mock_lambda_client, mock_cloudwatch_client, aws_credentials):
